...
namespace LapTop
{
    public partial class MacBForm : Form
    {
        public MacBForm()
        {
            InitializeComponent();
        ...
        private void MacBForm_Load(object sender, EventArgs e)
        {
        ...
        {
            MacBv.Size = new Size(56, 56);
            MacBv.Location = new Point(311, 289);
        }

        private void pictureBox18_MouseLeave(object sender, EventArgs e)
        {
            MacBv.Size = new Size(50, 50);
            MacBv.Location = new Point(314, 292);
        }

        private void MacBv_Click(object sender, EventArgs e)
        {
            textBox1.Enabled = true;
            textBox1.Text = "https://www.macrumors.com/roundup/macbook-pro/";
        }
