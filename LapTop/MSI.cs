...
namespace LapTop
{
    public partial class MSIForm : Form
    {
        ...
        private void pictureBox1logomsi_MouseEnter(object sender, EventArgs e)
        {
            pictureBox1logomsi.Size = new Size(301, 56);
            pictureBox1logomsi.Location = new Point(9, 9);
        }

        private void pictureBox1logomsi_MouseLeave(object sender, EventArgs e)
        {
            pictureBox1logomsi.Size = new Size(295, 50);
            pictureBox1logomsi.Location = new Point(12, 12);
        }
        ...
        {
            pictureBox19.Size = new Size(52, 52);
            pictureBox19.Location = new Point(256, 187);
        }

        private void pictureBox19_MouseLeave(object sender, EventArgs e)
        {
            pictureBox19.Size = new Size(50, 50);
            pictureBox19.Location = new Point(257, 188);
        }
        ...
        {
            MSIv.Size = new Size(56, 56);
            MSIv.Location = new Point(310, 289);
        }

        private void pictureBox18_MouseLeave(object sender, EventArgs e)
        {
            MSIv.Size = new Size(50, 50);
            MSIv.Location = new Point(313, 292);
        }

        private void MSIv_Click(object sender, EventArgs e)
        {
            textBox1.Enabled = true;
            textBox1.Text = "https://www.youtube.com/watch?v=zKm3WDfvkps";
        }
        ...
        private void btnDeleteMSI_Click(object sender, EventArgs e)
        {
